...
class MongoDbHandlerWBATest {

  private static final MongoDbHandlerWBA HANDLER_DEFAULT_MAPPING =
      new MongoDbHandlerWBA(createTopicConfig());

  private static final MongoDbHandlerWBA ERROR_TOLERANT_HANDLER =
      new MongoDbHandlerWBA(
          createTopicConfig(
  ...
  void testExistingDefaultConfig() {
    assertAll(
        ...
        () ->
            assertNotNull(
                new MongoDbHandlerWBA(createTopicConfig(), emptyMap()).getConfig(),
