...
public class WBAMongoSinkTaskIntegrationTest extends MongoKafkaTestCase {
          ...
          new HashMap<String, String>() {
            {
              ...
              put(
                  ...
                  "com.mongodb.kafka.connect.sink.cdc.debezium.mongodb.MongoDbHandlerWBA");
              put(MongoSinkTopicConfig.ERRORS_TOLERANCE_CONFIG, "all");
            }
          };
      task.start(cfg);
  ...
  public AutoCloseableSinkTask createSinkTask() {
    return new AutoCloseableSinkTask(new WBAMongoSinkTask());
  }

  static class AutoCloseableSinkTask extends SinkTask implements AutoCloseable {

    private final WBAMongoSinkTask wrapped;

    AutoCloseableSinkTask(final WBAMongoSinkTask wrapped) {
